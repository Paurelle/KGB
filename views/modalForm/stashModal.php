...
?>
                ...
                <div id="modal8" class="modal">
                    <div class="modal-content">
                        ...
                        <!-- form -->
                        <form action="controllers/CountryAdminPanel.php" method="POST" id="form22" class="formX">
                        ...
                        <!-- form -->
                        <form action="adminPanel.php" id="form23" class="formX">
                            <h2>Stash</h2>
                            <div class="form" >
                                <p>Modify</p>
                        ...
                        <!-- form -->
                        <form action="adminPanel.php" id="form24" class="formX">
                            <h2>Stash</h2>
                            <div class="form" >
                                <p>Delete</p>
